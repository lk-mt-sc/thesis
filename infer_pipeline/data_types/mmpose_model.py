class MMPoseModel():
    ...
    def get_from_selection_string(cls, selection_str):
        ...
        return MMPoseModel(
            section=selection_str_split[4],
            arch=selection_str_split[5],
            dataset=selection_str_split[1],
            input_size=selection_str_split[3],
            key_metric=selection_str_split[2],
            checkpoint=None,
            config=None,
    ...
    def __str__(self):
        return f'TL: {str(self.transfer_learned)} | {self.dataset} | {self.key_metric} | {self.input_size} | {self.section} | {self.arch}'
